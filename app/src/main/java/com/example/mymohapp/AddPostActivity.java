...
public class AddPostActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //click on image it asked to choose the image from gallery or camera
        ...
        //when user click on upload button , date to firebase
    ...
    private void uploadData(final String title, final String description){
        ...
        //i will get the time when the user upload the post
        final String timeStamp = String.valueOf(System.currentTimeMillis());
        //now i will set the filepath of our image
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                //uri is received post published to database
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>(){
                                            ...
                                            public void onSuccess(Void aVoid){
                                                ...
                                                //when post is published user must go to home activity, main dashboard
